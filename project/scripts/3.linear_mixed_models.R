...
# Build a correlations heatmmap
cor_matrix <- livecyte_collapsed_filtered |>
  select(all_of(features)) |>
  cor(method = "spearman")


# dry.mass               1.00000000  1.00000000  0.65504378 -0.33944234           -0.01300584 -0.20326299        0.16033296         0.04960317      0.01246102  
# volume                 1.00000000  1.00000000  0.65504378 -0.33944234           -0.01300584 -0.20326299        0.16033296         0.04960317      0.01246102
# radius                 0.65504378  0.65504378  1.00000000 -0.91590958           -0.51720677 -0.33340089        0.07990144        -0.19841038      -0.71204031
# sphericity            -0.33944234 -0.33944234 -0.91590958  1.00000000            0.61139015  0.33120839       -0.02760576         0.25693210      0.91937991
# length.to.width.ratio -0.01300584 -0.01300584 -0.51720677  0.61139015            1.00000000  0.06954381        0.13213847         0.32738470      0.63900782
# mean.speed            -0.20326299 -0.20326299 -0.33340089  0.33120839            0.06954381  1.00000000       -0.12055229         0.10997391      0.27002909
# total_path_length      0.16033296  0.16033296  0.07990144 -0.02760576            0.13213847 -0.12055229        1.00000000         0.46411514      0.03056600
# final_displacement     0.04960317  0.04960317 -0.19841038  0.25693210            0.32738470  0.10997391        0.46411514         1.00000000      0.28405594
# mean.thickness         0.01246102  0.01246102 -0.71204031  0.91937991            0.63900782  0.27002909        0.03056600         0.28405594      1.00000000

# Volume and dry mass are highly correlated, as are mean thickness,
# radius, and sphericity. Thus we will focus on volume and 
# sphericity in our analyses.
