...
# - Data assembling and debris filtering
# ============================================================
#
# 1. Load libraries ---------------------------------------------
#
...
#
# 3a. Initially, we can eliminate debris from colony A, replicate 1 and colony B, replicate 2 by using the manual dataset.
#
#
