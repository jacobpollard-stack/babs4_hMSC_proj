...
This study aimed to assess how the morphokinetic properties of two clonal lines of human mesenchymal stem cells (A and B) relate to their osteogenic differentiation potential. Cells were derived from bone marrow aspirate of the femoral head of a single patient- eliminating inter-donor variability- and immortalised via hTERT transduction to ensure a stable phenotype without replicative senescence (Adam et al., 2025). Livecyte ptychographic quantitative phase imaging (Phasefocus, Sheffield, UK; Marrison et al., 2013) was used to quantify 9 morphokinetic features across three technical replicates per clone, imaging every 23 minutes for 4 days- a duration sufficient to capture multiple cellular generations- resulting in 7,916 single-cell observations. Downstream filtration of debris reduced this to 664 (clone A) and 612 (clone B) cells. Fluorescence microscopy with Alexa-594-conjugated phalloidin and DAPI was used to visualise F-actin architecture and nuclear morphology, as cytoskeletal reorganisation- particularly large spreading area and high stress fibre density- is associated with osteogenesis (Khan et al., 2020). Osteogenic differentiation was assessed by measuring alkaline phosphatase activity via spectrophotometry- as this is an early marker of osteoblast commitment- after 8 days in osteogenic inductive medium (Siffert, 1951). As the data were hierarchical and cells within the same replicate share the same conditions, thus cannot be treated independently, statistical analysis was performed in R (version 4.4.1; R Core Team, 2024), using linear mixed models to compare morphokinetic features between clones, with clone as a fixed effect and replicate as a random effect. Principal component analysis was performed to visualise the multivariate separation between clones. Finally, the osteogenic potential of the two clones was compared to assess whether the observed morphokinetic differences were predictive of differentiation potential.
