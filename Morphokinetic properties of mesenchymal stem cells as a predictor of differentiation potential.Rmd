...
Human mesenchymal stem cells (hMSCs) are multipotent non-hematopoietic cells found in bone marrow stroma that are capable of self-renewal and can differentiate into a range of mesodermal tissues, such as bone, fat, cartilage, and muscle (Aldahmash et al., 2012). Due to their high culturability and multipotency, they are increasingly used in the clinical treatment of a variety of conditions, including non-healing bone fractures (Trombi et al., 2016), diabetic neuropathy (Liu and Tang, 2016), and diverse brain injuries (Hsuan et al., 2016). However, hMSC populations are highly heterogenous: within a single bone marrow aspirate, differentiation potential for a rangle of cell lineages is exhibited (Costa et al., 2021). This variation imposes a significant barrier to hMSC-based therapies as the potency of a patient-derived aspirate is unpredictable, limiting the efficacy of hMSCs in the treatment of disease. Thus, identifying clonal lines with high differentiation potential before committing to extensive differentiation assays would significantly improve the long-term sustainability of hMSC therapies. Currently, there are no definitive molecular markers of differentiation potential (Smith et al., 2025); however, fluorescence imaging shows that the cytoskeletal architecture of hMSCs changes in response to osteogenesis induction, with cells increasing in F-actin stress fibre density and cell spreading area. Furthermore, Matsuoka et al. (2013) demonstrated that morphological features obtained by phase-contrast imaging could predict osteogenic differentiation with high accuracy (R > 0.89), while Lee et al. (2014) showed that biophysical properties, including cell size and stiffness, correlate with multipotency. 
