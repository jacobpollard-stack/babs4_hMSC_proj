...
Human mesenchymal stem cells (hMSCs) are multipotent non-hematopoietic cells found in bone marrow stroma that are capable of self-renewal and can differentiate into a range of mesodermal tissues, such as bone, fat, cartilage, and muscle (Aldahmash et al., 2012). Due to their high culturability and multipotency, they are increasingly used in the clinical treatment of a variety of conditions, including non-healing bone fractures (Trombi et al., 2016), diabetic neuropathy (Liu and Tang, 2016), and diverse brain injuries (Hsuan et al., 2016). However, hMSC populations are highly heterogenous: within a single bone marrow aspirate, clonal subpopulations exhibit varying differentiation potential (Costa et al., 2021). This variation imposes a significant barrier to hMSC-based therapies as the potency of a patient-derived aspirate is unpredictable, limiting the treatment's efficacy. Thus, identifying clonal lines with high differentiation potential before committing to extensive differentiation assays could significantly improve the long-term prognosis of hMSC therapies. Currently, there are no definitive molecular markers of differentiation potential (Smith et al., 2025); however, fluorescence imaging shows that the cytoskeletal architecture of hMSCs changes in response to osteogenesis induction, with cells increasing in F-actin stress fibre density and cell spreading area (Khan et al., 2020). This was further explored by Matsuoka et al. (2013), who demonstrated that morphological features obtained by phase-contrast imaging could predict osteogenic differentiation with high accuracy (R > 0.89), while Lee et al. (2014) showed that biophysical properties, including cell size and stiffness, correlate with multipotency. Cell motility is also shown to be a predictor of differentiation potential: Bertolo et al., 2015 found that in-vitro cell speed can distinguish multipotent from unipotent hMSC subpopulations. Despite this research, the relationship between morphokinetic properties of hMSCs and their differentiation potential has only been explored via phase-contrast microscopy, limiting temporal resolution and sample size. We instead aim to perform high-throughput ptychographic quantitative phase imaging utilising the Livecyte microscope (Phasefocus, Sheffield, UK; Marrison et al., 2013), allowing us to analyse 6 morphological and 3 kinetic parameters of two clonal lines of hMSCs. We will then use an osteogenesis assay to determine the differentiation potential of each clone, and determine whether the differences observed are sufficient to separate the two clones in a multivariate space.

# Approach

This study aimed to assess how the morphokinetic properties of two clonal lines of human mesenchymal stem cells (A and B) relate to their osteogenic differentiation potential. Cells were derived from bone marrow aspirate of the femoral head of a single patient in order to exclude inter-donor variability, and immortalised via hTERT transduction to ensure a stable phenotype without replicative senescence (Adam et al., 2025). Livecyte ptychographic quantitative phase imaging (Phasefocus, Sheffield, UK; Marrison et al., 2013) was used to quantify 9 morphokinetic features across three technical replicates per clone. An image was taken every 23 minutes for 4 days- a duration sufficient to capture cell movement- resulting in 7,916 single-cell observations. Downstream filtration of debris reduced this to 664 (clone A) and 612 (clone B) cells. Fluorescence microscopy with Alexa-594-conjugated phalloidin and DAPI was used to visualise F-actin architecture and nuclear morphology, as cytoskeletal reorganisation- particularly large spreading area and high stress fibre density- is associated with osteogenesis (Khan et al., 2020). Osteogenic differentiation was assessed by measuring alkaline phosphatase activity via spectrophotometry- as this is an early marker of osteoblast commitment (Siffert, 1951)- after 8 days in osteogenic inductive medium. As the data were hierarchical and cells within the same replicate share the same conditions, thus cannot be treated independently, linear mixed models were used to compare morphokinetic features between clones, with clone as a fixed effect and replicate as a random effect. Principal component analysis was performed to visualise the multivariate separation between clones. Statistical analyses were performed in R (version 4.4.1; R Core Team, 2024).
