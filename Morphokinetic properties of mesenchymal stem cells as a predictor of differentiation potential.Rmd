...
Human mesenchymal stem cells (hMSCs) are multipotent non-hematopoietic cells found in bone marrow stroma that are capable of self-renewal and can differentiate into a range of mesodermal tissues, such as bone, fat, cartilage, and muscle (Aldahmash et al., 2012). Due to their high culturability and multipotency, they are increasingly used in clinical settings in the treatment of a variety of conditions, including non-healing bone fractures (Trombi et al., 2016), diabetic neuropathy (Liu and Tang, 2016), and diverse brain injuries (Hsuan et al., 2016). 
